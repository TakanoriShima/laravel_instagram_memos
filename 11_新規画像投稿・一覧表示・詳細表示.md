...
+--------+-----------+-------------------------+------------------+-------------------------------------------------------------------+--------------+
```
## 4. /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
...
## 5. /bbs/resources/views/top.blade.php 変形
```
@extends('layouts.app')
@section('title',  '投稿一覧')
@section('content')
...
## 6. /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
...
## 7. /bbs/resources/views/posts/show.blade.php 新規作成・編集
```
@extends('layouts.app')
...
## 9. /bbs/resources/views/layouts/app.blade.php 追記
```
<!DOCTYPE html>
<html lang="ja">
    <head>
...
## 10. /bbs/app/Http/Controllers/ToppagesController.php　編集
```
<?php
...
## 11. /bbs/resources/views/welcome.blade.php 編集
```
@extends('layouts.app')
...
## 12. /bbs/public/css/style.css 追記編集
```
.image_tile {
    width: 100%;
}
...
```
## 13. /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
...
## 14. /bbs/resources/views/posts/create.blade.php　新規作成・編集
```
@extends('layouts.app')
...
## 15 /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
