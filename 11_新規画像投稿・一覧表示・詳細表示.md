...
## 10. /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
...
## 11. /bbs/resources/views/posts/create.blade.php　新規作成・編集
```
@extends('layouts.app')
...
## 12 /bbs/app/Http/Controllers/PostsController.php 追記
```
    /**
