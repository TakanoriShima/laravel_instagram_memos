...
```
## 1. /bbs/resources/views/posts/show.blade.php 編集
```
@extends('layouts.app')
@section('content')
...
## 2. /bbs/app/Http/Controllers/PostsController.php 編集
```
    /**
...
## 3. /bbs/resources/views/posts/edit.blade.php 新規作成・編集
```
@extends('layouts.app')
...
@endsection
```
## 4. /bbs/app/Http/Controllers/PostsController.php 編集
```
    /**
...
## 5. /bbs/app/Http/Controllers/PostsController.php 編集
```
    /**
