...
## 3. /bbs/resources/views/layouts/app.blade.php 追記
```
<!DOCTYPE html>
<html lang="ja">
    <head>
...
## 4. /bbs/app/Http/Controllers/UsersController.php 追記
```
<?php
...
## 5. /bbs/resources/views/users/favorites.blade.php 新規作成・編集
```
@extends('layouts.app')
...
## 6. /bbs/resources/views/users/show.blade.php 変更
```
@extends('layouts.app')
