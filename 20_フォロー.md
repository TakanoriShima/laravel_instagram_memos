...
## 2. /bbs/database/migrations/2021_08_31_110656_create_user_follow_table.php 編集
```
    /**
     * Run the migrations.
     *
...
```
## 8. /bbs/app/Http/Controllers/UserFollowController.php 追記
...
## 11. /bbs/resources/views/users/show.blade.php 変更
```
@extends('layouts.app')
...
@endsection
```
## 12. /bbs/app/Http/Controllers/UsersController.php 追記
```
<?php
...
## 13. /bbs/resources/views/users/followings.blade.php　新規作成、編集
```
@extends('layouts.app')
...
## 14. /bbs/resources/views/users/followers.blade.php 新規作成、編集
```
@extends('layouts.app')
...
## 15. /bbs/resources/views/layouts/app.blade.php 編集
```
<!DOCTYPE html>
<html lang="ja">
    <head>
...
## 17. /bbs/app/Http/Controllers/UsersController.php 追記
```
    // タイムラインデータ表示
...
## 20. /bbs/resources/views/layouts/app.blade.php 変更
```
<!DOCTYPE html>
<html lang="ja">
    <head>
...
## 21. /bbs/resources/views/users/timelines.blade.php 新規作成、編集
```
@extends('layouts.app')
