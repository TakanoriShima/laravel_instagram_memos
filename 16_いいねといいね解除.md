...
## 2. /bbs/database/migrations/2021_08_25_131040_create_favorites_table.php 編集
```
    public function up()
    {
...
## 8. /bbs/app/Http/Controllers/FavoritesController.php 追記
```
<?php
...
## 11. /bbs/app/Http/Controllers/PostsController.php 変更
```
    /**
...
## 12. /bbs/resources/views/posts/show.blade.php 変形
```
@extends('layouts.app')
