...
```
## 1. /bbs/resources/views/top.blade.php　編集
```
@extends('layouts.app')
@section('title',  '投稿一覧')
@section('content')
...
## 2. /bbs/resources/views/users/index.blade.php 変更
```
@extends('layouts.app')
@section('title', '会員一覧')
@section('content')
...
## 3. /bbs/resources/views/posts/show.blade.php
```
@extends('layouts.app')
